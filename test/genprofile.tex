...
\gprKeys{
	...
	page number handler = {s.~#1},
%	reference handler = {\textsuperscript{#1}\footnote{#2}},
%	reference handler = {\footnote{#1, #2}},
%	id in index entries,
}
...
\gprKeys{
	...
	after life events = {\vspace*{5pt}\hrule\vspace*{5pt}},
