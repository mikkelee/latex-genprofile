...
\makeindex[name=gpr-given, title={Register på fornavn}, options=-s genprofile]
...
%	auto id prefix = {L/},
	...
	id index = gpr-id,
	full name index = gpr-fullname,
	given name index = gpr-given,
...
Test name formatting: (\gprName{_ _ Mozart})
...
% Should cause error: \gprYear{1820}
